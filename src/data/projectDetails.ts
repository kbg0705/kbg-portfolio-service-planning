...
export const projectDetails: ProjectDetail[] = [
  {
    slug: 'printbank-npb',
    overview: '회원, 주문, 배송, 문의 기능이 개별적으로 확장되면서 사용자 상태와 운영 처리 기준이 불명확해졌습니다. 운영 현장의 VOC를 FO·BO 개선 과제로 구조화하고 개발 가능한 정책으로 전환했습니다.',
    context: '사용자 문의와 운영 요청이 여러 문서와 채널에 흩어져 있어 같은 문제의 원인, 담당 권한, 개발 상태를 파악하기 어려웠습니다. 운영자의 경험에 의존하던 규칙을 제품 정책으로 옮기는 것이 핵심 과제였습니다.',
    executiveSummary: {
      problem: '운영자가 사용자 상태와 서비스 정책 사이의 공백을 수작업으로 보완하고 있었습니다.',
      decision: '운영 피드백을 FD 문제 정의와 RP 개선 과제로 구조화하고 상태, 조건, 예외, 권한, 우선순위를 정책으로 만들었습니다.',
      outcome: '회원, 주문, 배송, CS 개선 과제를 개발과 QA 단계로 연결하고 문제, 사용자 상태, 개발 상태를 하나의 관리 기준으로 통합했습니다.',
    },
    evidence: [
      { label: 'CS 및 운영 문의 분류', description: '반복 문의를 기능, 정책, 운영 이슈로 나누어 공통 원인을 확인했습니다.' },
      { label: 'FO·BO 기능 진단', description: '사용자 화면과 운영 화면 사이의 정보 흐름, 권한, 누락 지점을 점검했습니다.' },
      { label: '상태값과 업무 흐름 분석', description: '상태가 바뀌는 조건, 판단 주체, 처리 권한, 책임 범위를 추적했습니다.' },
    ],
    feedbackBacklog: {
    ...
    decisions: [
      {
        ...
        effect: '운영, 기획, 개발이 같은 기준으로 문제, 사용자 상태, 진행 상태를 확인하고 우선순위를 논의할 수 있게 됐습니다.',
      },
      {
        number: '02',
        ...
        specification: '승인과 반려, 초기화, 주문 연동, 중복 주문 방지, 배송 로그, 운영 권한 관리 기준을 문서화했습니다.',
  ...
  {
    slug: 'magic-ecole',
    overview: '고정된 교육 플랫폼의 역할·권한 체계와 낮은 콘텐츠 재사용성 때문에 새로운 운영 요구가 생길 때마다 추가 개발이 필요했습니다.',
    context: '전역 권한과 강의 내부 권한을 분리하고 사용자 역할, 콘텐츠 라이브러리, 강의 구조, 운영자 설정을 확장 가능한 정책으로 설계했습니다.',
    executiveSummary: {
