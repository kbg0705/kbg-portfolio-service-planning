...
export const projectDetails: ProjectDetail[] = [
  {
    ...
    executiveSummary: {
      ...
      outcome: '회원, 주문, 배송, CS 개선 과제를 개발과 QA 단계로 연결하고 메인페이지 평균 참여시간을 약 1.7배 높였습니다.',
    },
    evidence: [
      ...
      { label: 'GA4 참여 지표', description: '메인페이지 개선 전후의 평균 참여시간을 비교했습니다.' },
    ],
    feedbackBacklog: {
    ...
    decisions: [
      ...
      },
      {
        number: '03',
        title: '메인페이지의 역할 재정의',
        evidence: '기존 메인페이지는 주문 기능 중심으로 구성되어 상품 탐색과 상담 진입이 어려웠습니다.',
        decision: '상품 탐색, 제작 안내, 상담 진입을 메인페이지의 핵심 역할로 정의했습니다.',
        specification: '배너, 팝업, 콘텐츠, 상담 CTA의 정보 우선순위를 재설계했습니다.',
        effect: '평균 참여시간이 1분 14초에서 2분 8초로 증가했습니다.',
      },
    ],
    artifacts: [],
    collaboration: [
    ...
    learnings: [
      '체류시간은 길고 짧음보다 사용자의 목적 수행 여부와 함께 판단해야 합니다.',
